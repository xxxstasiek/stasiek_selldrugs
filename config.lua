...
Config.WeedPrice = 120	-- sell price for single, not pooch (black money)
Config.MethPrice = 140	-- sell price for single, not pooch (black money)
Config.CokePrice = 160	-- sell price for single, not pooch (black money)
Config.OpiuPrice = 180	-- sell price for single, not pooch (black money)